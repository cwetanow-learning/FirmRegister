        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    role.Name = GlobalConstants.EmployeeRole;
                    roleManager.Create(role);

                    var secondRole = new IdentityRole();
                    secondRole.Name = GlobalConstants.OperatorRole;
                    roleManager.Create(secondRole);

                    UserManager.AddToRole(currentUser.Id, GlobalConstants.EmployeeRole);
                    UserManager.AddToRole(currentUser.Id, GlobalConstants.OperatorRole);
